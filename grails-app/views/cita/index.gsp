    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="tcitas" action="tcitas"><g:message code="Ver Todas Las Citas" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <p><center><button id="btnLimpiar" onclick="limpiar()">Limpiar Citas</button></center></p>
        ...
        var fecha = new Date();
          ...
          function limpiar(){
          $.post("${g.createLink(action: 'limpiar')}", {fecha: fecha}, function(result) {
              $("#btnLimpiar").text("Citas limpiadas");
          }); 
          location.reload(true);
          
          alert("Se ha limpiado las citas previas al dia actual");
        }

...
<html>
    ...
    <body>
        <a href="#edit-documentos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-documentos" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.documentos}" method="PUT">
                <g:hiddenField name="version" value="${this.documentos?.version}" />
                <fieldset class="form">
                    <f:all bean="documentos"/>
                </fieldset>

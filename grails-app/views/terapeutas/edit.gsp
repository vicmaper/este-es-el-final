...
<html>
    ...
    <body>
        <a href="#edit-terapeutas" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-terapeutas" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.terapeutas}" method="PUT">
                <g:hiddenField name="version" value="${this.terapeutas?.version}" />
                <fieldset class="form">
                    <f:field property="tTelefono"/>
                    <label>Status:</label><select name="pStatus"><option>Activo</option><option>Baja</option></select>
                </fieldset>
